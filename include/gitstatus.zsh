...
ZSH_THEME_GIT_PROMPT_BRANCH="%B%F{cyan}"
ZSH_THEME_GIT_PROMPT_NO_UPSTREAM="(local)"
ZSH_THEME_GIT_PROMPT_BEHIND="%F{yellow}v"
ZSH_THEME_GIT_PROMPT_AHEAD="%F{magenta}^"
ZSH_THEME_GIT_PROMPT_STASHED="%F{yellow}&"

ZSH_THEME_GIT_PROMPT_MODIFIED="%B%F{green}+"
ZSH_THEME_GIT_PROMPT_DELETED="%B%F{red}-"
ZSH_THEME_GIT_PROMPT_STAGED="%F{yellow}s"
ZSH_THEME_GIT_PROMPT_UNTRACKED="%F{cyan}u"
ZSH_THEME_GIT_PROMPT_CONFLICTS="%B%F{red}!"
